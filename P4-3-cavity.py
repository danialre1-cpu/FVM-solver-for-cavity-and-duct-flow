...
p1='pressure'+str(Ut)+'_'+str(nx)+'.eps'
if Ut !=0:
...
u1='uvelocity'+str(Ut)+'_'+str(nx)+'.eps'
if Ut !=0:
...
v1='vvelocity'+str(Ut)+'_'+str(nx)+'.eps'
if Ut !=0:
...
'''
III2=pd.read_csv('Beta'+'.csv',sep=',',header=None)
III2=III2.to_numpy()
plt.plot(III2[:,0],III2[:,1])
plt.grid()
plt.ylabel(r'$Iterations$')
plt.xlabel(r'$\beta$')
#plt.savefig('./figs/'+'Beta'+'.eps',format='eps') 
plt.show()
'''

'''
filename='u_r_'+str(Ut)+str(nx)
...
filename2='UU'+str(Ut)+str(nx)
df=pd.DataFrame(UU)  
df.to_csv(filename2+'.csv',index=False,header=False)



AA=pd.read_csv('UU110'+'.csv',sep=',',header=None)
AA=AA.to_numpy()

BB=pd.read_csv('UU120'+'.csv',sep=',',header=None)
BB=BB.to_numpy()


CC=pd.read_csv('UU140'+'.csv',sep=',',header=None)
CC=CC.to_numpy()

DD=pd.read_csv('UU180'+'.csv',sep=',',header=None)
DD=DD.to_numpy()
...
plt.plot(DD[:,0],DD[:,1])
plt.grid()
leg=[r'$10\times 10$',r'$20\times 20$',r'$40\times 40$',r'$80\times 80$']
plt.legend(leg)
plt.xlabel(r'$u$')
plt.ylabel(r'$y$')
#plt.savefig('./figs/'+'sym'+'.eps',format='eps') 
plt.show()


filename33='Iteration'+str(Ut)+str(nx)+str(dt)
ITH=np.concatenate((Iterationi.reshape(-1,1),l2pii.reshape(-1,1),l2uii.reshape(-1,1),l2vii.reshape(-1,1)),axis=1)
df33=pd.DataFrame(ITH)
df33.to_csv(filename33+'.csv',index=False,header=False)


III2=pd.read_csv('Iteration120'+'.csv',sep=',',header=None)
III2=III2.to_numpy()
...
plt.ylabel(r'$L_2$')
plt.yscale('log')
#plt.savefig('./figs/'+'It200.04'+'.eps',format='eps') 
plt.show()


III0=pd.read_csv('Iteration0200.04'+'.csv',sep=',',header=None)
III0=III0.to_numpy()
...
plt.ylabel(r'$L_2$')
plt.yscale('log')
#plt.savefig('./figs/'+'It020exp'+'.eps',format='eps') 
plt.show()
...
plt.ylabel(r'$L_2$')
plt.yscale('log')
#plt.savefig('./figs/'+'It20'+'.eps',format='eps') 
plt.show()

IIIe2=pd.read_csv('Iteration120Exp'+'.csv',sep=',',header=None)
IIIe2=IIIe2.to_numpy()
plt.plot(IIIe2[:,0],IIIe2[:,1:4])
leg=[r'$L_{2}p$',r'$L_{2}u$',r'$L_{2}v$']
plt.legend(leg)
plt.grid()
plt.xlabel(r'$Iterations$')
plt.ylabel(r'$L_2$')
plt.yscale('log')
#plt.savefig('./figs/'+'Ite20'+'.eps',format='eps') 
plt.show()
...
III0=pd.read_csv('Iteration0200.05'+'.csv',sep=',',header=None)
III0=III0.to_numpy()
plt.plot(III0[:,0],III0[:,1:4])
leg=[r'$L_{2}p$',r'$L_{2}u$',r'$L_{2}v$']
plt.legend(leg)
...
IIIi20=pd.read_csv('Iteration1200.01'+'.csv',sep=',',header=None)
IIIi20=IIIi20.to_numpy()
plt.plot(IIIi20[:,0],IIIi20[:,1:4])
leg=[r'$L_{2}p$',r'$L_{2}u$',r'$L_{2}v$']
plt.legend(leg)
plt.grid()
plt.xlabel(r'$Iterations$')
plt.ylabel(r'$L_2$')
plt.yscale('log')
#plt.savefig('./figs/'+'Iti200.01'+'.eps',format='eps') 
plt.show()
'''